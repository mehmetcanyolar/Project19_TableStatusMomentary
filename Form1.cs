...
namespace Project19_TableStatusMomentary
{
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            var buttons = this.Controls.OfType<Button>(); // filtreleme işlemi
            foreach (var itemButton in buttons)
            {
                this.Controls.Remove(itemButton);  //Eski masa buttonlerını silip her seferinde güncel masa bilgilerini getirir
            }
